package service.resource.config;
...
@Configuration
@ComponentScan(basePackages = {"service.resource" },
	excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = {"service.resource.web.*" }))
